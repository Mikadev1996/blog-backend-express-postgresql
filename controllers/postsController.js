...
exports.get_post = (req, res, next) => {
    ...
    const text2 = 'SELECT comments.comment_id, comments.text, comments.timestamp, users.user_id, users.username, users.picture_url FROM comments INNER JOIN users ON comments.user_id = users.user_id WHERE comments.post_id = $1 ORDER BY timestamp DESC';
